...
in
{
  contrailApi = buildContrailImageWithPerp "opencontrail/api"
    ...
    ''consul-template-wrapper -- -once  -template="${config.contrail.api}:/etc/contrail/contrail-api.conf"'';
  contrailDiscovery = buildContrailImageWithPerp "opencontrail/discovery"
    ...
    ''consul-template-wrapper -- -once  -template="${config.contrail.discovery}:/etc/contrail/contrail-discovery.conf"'';
  contrailControl = buildContrailImageWithPerp "opencontrail/control"
    ...
    ''consul-template-wrapper -- -once  -template="${config.contrail.control}:/etc/contrail/contrail-control.conf"'';
  contrailCollector = buildContrailImageWithPerp "opencontrail/collector"
    ...
    ''consul-template-wrapper -- -once  -template="${config.contrail.collector}:/etc/contrail/contrail-collector.conf"'';
  contrailAnalyticsApi = buildContrailImageWithPerp "opencontrail/analytics-api"
    ...
    ''consul-template-wrapper -- -once  -template="${config.contrail.analyticsApi}:/etc/contrail/contrail-analytics-api.conf"'';
  contrailSchemaTransformer = buildContrailImageWithPerp "opencontrail/schema-transformer"
    ...
    ''consul-template-wrapper -- -once  -template="${config.contrail.schemaTransformer}:/etc/contrail/contrail-schema-transformer.conf"'';
  contrailSvcMonitor = buildContrailImageWithPerp "opencontrail/svc-monitor"
    ...
    ''consul-template-wrapper -- -once  -template="${config.contrail.svcMonitor}:/etc/contrail/contrail-svc-monitor.conf"'';
