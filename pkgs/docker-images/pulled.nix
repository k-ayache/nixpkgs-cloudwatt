...

{
  ...
  consulAgentImage = dockerTools.pullImage {
  ...
  developmentMysqlImage = dockerTools.pullImage {
  ...
  developmentPolipoImage = dockerTools.pullImage {
  ...
  developmentPolymurImage = dockerTools.pullImage {
  ...
  developmentRabbitmqImage = dockerTools.pullImage {
  ...
  developmentRegistratorImage = dockerTools.pullImage {
  ...
  developmentVaultImage = dockerTools.pullImage {
  ...
  openstackToolsImage = dockerTools.pullImage {
  ...
  zookeeperImage = dockerTools.pullImage {
    imageName = "zookeeper";
    imageTag = "3.4.11";
    sha256 = "1g7vpw1yfdd4q70h7yzvksb68qvgq0fvj5qhq01sijs9dnmwzh6p";
  };

  cassandraImage = dockerTools.pullImage {
    imageName = "cassandra";
    imageTag = "2.1.9";
